...
export const DraggableCardBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'relative min-h-96 w-80 overflow-hidden rounded-md  p-6 shadow-2xl transform-3d bg-neutral-900',
        className
      )}
    >
      {children}
...
export const DraggableCardContainer = ({
  ...
  return <div className={cn('[perspective:3000px] z-100', className)}>{children}</div>;
};
